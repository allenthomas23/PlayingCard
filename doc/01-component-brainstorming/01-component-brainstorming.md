...
- **Dot Number**: Thomas.4994 <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **Due Date**: 2/16/24<!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
- Component Design #1:
  ...
  - **Kernel Methods**: getSuit() - gives the suit of the class, getRank() - gets the color
  setSuit(String s)
  setRank(String s)
  getCardInfo();
  - **Secondary
